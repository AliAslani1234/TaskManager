<template>
<div class="modal fade" id="AddSubUserModal" tabindex="-1" role="dialog" aria-labelledby="AddSubUserModal" aria-hidden="true">
    ...
    const addSub = () => {
      ...
      validationSchema
        ...
        .then(() => {
          ...
          axios
            .post(`http://localhost:3000/api/v1/users/${id.value}/sub`, data, {
